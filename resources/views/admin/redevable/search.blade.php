                ...
                <div class="card-header row">
                    ...
                    <div class="col col-sm-5">
                        {{-- <div class="card-options text-right">
			                    ...
			                    <a href="{{url('redevables/create')}}" class=" btn btn-outline-primary btn-semi-rounded
                        ">Ajouter Redevable</a>
                        @endcan
                    </div> --}}
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @endcan
                                    @can('redevable_edit')
                                    <a href="{{ route('redevables.edit', $redevable->id) }}"><i
                                            class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                    @endcan
                                    @can('redevable_delete')
                                    <form action="{{ route('redevables.destroy', $redevable->id) }}" method="POST"
                                    ...
                                    @endcan
                                    @can('redevable_create')
                                    <a href="{{url('autorisation/create')}}" title="ajouter Autorisation"><svg
