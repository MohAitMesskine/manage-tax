                             ...
                             <tbody>
                                 ...
                                 <tr>
                                     ...
                                     <td>
                                         ...
                                         @endcan
                                         @can('redevable_edit')
                                         <a href="{{ route('autorisation.edit', $autorisation->id) }}"><i
                                                 class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                         @endcan
                                         @can('redevable_delete')
                                         <form action="{{ route('autorisation.destroy', $autorisation->id) }}"
                                         ...
                                         <a title="ajouter autorisation" href="{{url('payement/create')}}"
                                             title="ajouter payement">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16"
                                                 fill="currentColor" class="bi bi-plus-circle f-16 mr-15"
                                                 viewBox="0 0 16 16">
                                                 <path
                                             ...
                                             @endcan
                                             <a href="{{ route('imprimer', $autorisation->id) }}" title="imprimer">
                                                 <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16"
