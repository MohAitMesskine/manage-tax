                                                    ...
                                                    <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                            <input type="text" name="valeurlocative" class="form-control"  placeholder="Saisir La Valeur Locative">
                                                                            </div>
                                                                         </div>
                                                                         <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-9">
                                                                                <div class="form-floating">
                                                                                    <textarea name="observation" class="form-control" placeholder="Votre openion" id="floatingTextarea"></textarea>
